  ...
  return (
    <div className="glass-card" style={{ maxHeight: '85vh', overflowY: 'auto', padding: '30px 25px' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="submit-btn">Registrarme como Administrador</button>

        <div style={{ marginTop: '15px', textAlign: 'center' }}>
          <Link to="/admin/login" className="card-link">¿Ya tienes cuenta?</Link>
        </div>
      </form>
    </div>
  );
